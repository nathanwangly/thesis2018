    ...
    while instructions_mode:
        for event in pygame.event.get():
            ...
            # Instructions 2 - SPENDING MONEY
                ...
                instruction_string2 = 'Each month, after paying your bills, you are left with a disposable income of $' + str(income) + '.'
            ...
            # Instructions 3 - EARNING POINTS
                ...
                instruction_string2 = 'For every ' + str(reward_rate) + ' points you earn, you will be rewarded with $0.10 of real money.'
            ...
            # Instructions 4 - NUDGE INFORMATION
                ...
                textPrint(instruction_string1, (display_width / 2, display_height / 3.5))
            ...
            # Instructions 5 - COMPREHENSION CHECK
...
def round_reward(money_spent):
    ...
    data_storage(mode, money_spent, points_total, current_savings)
...
def game_outcome():
    ...
    if outcome == 'win':
        ...
        textPrint(outcome_string, (display_width / 2, display_height / 1.9), size=font_size_extralarge)
        ...
        if mode == 'practice':
            payment_string = 'You would have earned $' + str(reward) + ' in this experiment.'
        ...
        if mode == 'practice':
            loss_string = 'As a result, you would not have been rewarded for the points you earned during the game.'
...
def experiment_end():
    ...
    textPrint('Please let the experimenter know that you are finished!', (display_width / 2, display_height / 1.6), size=font_size_large)
...
def nextLine(text, bold=False, size=font_default_size):
    global line_spacing
...
def data_storage(mode, money_spent, points_total, current_savings):
...
def data_output():
    ...
    data_list = [participant_ID, practice_responses, practice_points, practice_savings, exp_responses, exp_points, exp_savings]
...
def main():
    ...
    global mode, points_total, current_savings, round_number
